...
const Home = () => {
  return (
    <div className="relative h-[90vh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-20 overflow-y-auto py-10 md:py-0">
        <h1 className="intro-title-1 text-white text-center mt-[200px] sm:mt-0">Discover Amazing</h1>
        <h2 className="intro-title-2 text-center" >Destinations</h2>
        <p className='text-white text-lg md:text-2xl text-center px-4 mt-4'>Share your travel experiences and get an opportunity to win free tickets on next trip,</p>
        <p className='text-white text-lg md:text-2xl text-center px-4 mb-6'>Recover items lost during your trip with our lost-and-found.</p>
        <div className='feature-boxes flex flex-col md:flex-row justify-center md:justify-around items-center gap-6 md:gap-4 mt-4 md:mt-5 w-full px-6 max-w-6xl mx-auto pb-10 md:pb-0'>
