...
const Home = () => {
  return (
    <div className="relative h-[90vh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-start md:justify-center z-20 overflow-y-auto pt-24 pb-10 md:py-0 w-full">
        ...
        <div className="max-w-3xl px-4 mt-6">
          <p className='text-white text-base sm:text-lg md:text-xl lg:text-2xl text-center leading-relaxed drop-shadow-md'>Share your travel experiences and get an opportunity to win free tickets on next trip,</p>
          <p className='text-white text-base sm:text-lg md:text-xl lg:text-2xl text-center leading-relaxed drop-shadow-md mt-2'>Recover items lost during your trip with our lost-and-found.</p>
        </div>
        <div className='feature-boxes flex flex-col md:flex-row justify-center md:justify-around items-center gap-6 md:gap-4 mt-8 md:mt-5 w-full px-6 max-w-6xl mx-auto'>
